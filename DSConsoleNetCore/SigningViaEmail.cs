...
public class SigningViaEmail
{
    ...
    public static string SendEnvelopeViaEmail(string signerEmail, string signerName, string ccEmail, string ccName,
        string accessToken, string basePath, string accountId, string envStatus)
    {
        // Step 1 start
        EnvelopeDefinition env = MakeEnvelope(signerEmail, signerName, ccEmail, ccName, envStatus);
    ...
    public static EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName, string ccEmail, string ccName,
        string envStatus)
    {
